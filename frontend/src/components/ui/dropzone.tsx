...
export const Dropzone = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'relative h-auto w-full flex-col overflow-hidden rounded-xl border-2 border-dashed p-12 cursor-pointer transition-all duration-200',
          isDragActive
            ? 'border-[var(--color-text-primary)] bg-[var(--color-text-primary)]/5'
            : 'border-[var(--color-border)] hover:border-[var(--color-text-primary)]/50',
